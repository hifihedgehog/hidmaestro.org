...
<div class="pf-cards">
  ...
  <a href="profiles/">
    ...
    <h3>Profiles</h3>
    <p>The JSON profile system, 225 built-in controllers, custom and cloned devices, and the extractor that captures yours.</p>
  </a>
...
user-mode driver, 225 embedded profiles, runtime-built custom profiles,
